...
// 3. Сделай так, чтобы у объектов-ведьмаков нельзя было вызывать методы класса Object (немного tricky, поэтому сразу добавил ответ в ./answers/object-prototype.md).
```
